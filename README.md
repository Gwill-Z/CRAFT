...
<p align="center">
  <img src="figs/appen_demo-succ.jpg" alt="Results" width="800">
</p>
...
**1. Implement the Model Wrapper**
   ...
   - You must implement the following key methods:
     ...
     - ... and other methods required for your specific attack logic, you can follow the florence2.py.
...
**3. Implement Evaluation Logic**
   ...
   - In this script, implement the specific logic to test the four tasks (Captioning, OD, Region Categorization, OVD) using your new model's outputs. You will need to define how to parse its generations to determine attack success. You can follow the evaluate_f2.py
